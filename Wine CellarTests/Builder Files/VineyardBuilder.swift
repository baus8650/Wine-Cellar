...
final class VineyardBuilder {
    ...
    private var location = CLLocation(latitude: 45.043889, longitude: -0.6687277)
    ...
    func location(_ location: CLLocation) -> Self {
        self.location = location
        return self
    }
    
    func build() -> Vineyard {
        return Vineyard(name: name, address: address, latitude: latitude, longitude: longitude, location: location)
    }
}
